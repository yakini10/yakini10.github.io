<div class="container">
    <?php if (!empty($_SESSION['user_id'])): ?>
        <div style="text-align: right; margin-bottom: 20px; padding-bottom: 10px; border-bottom: 1px solid #e0e0e0;">
            <span style="color: #667eea; margin-right: 15px;">✓ Вы авторизованы</span>
